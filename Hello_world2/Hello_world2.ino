...
void loop() {                 
  ...
  Serial.print("Hello world!"); // envia misatge ''Hello world'' a l'ordinador
  delay(1000);                  //esperat 1 segon
                              ...
                              // s'esperar un segon i repetira aquesta comunicacio,com que el programa esta escrit a ``loop´´ aixo ho fara de manera repetida(bucle)
//************************** FUNCIONS ***************************
